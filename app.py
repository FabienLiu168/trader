...
# 基本設定
# =========================
st.set_page_config(page_title="大盤趨勢/個股期貨 (法酷交易室)", layout="wide")
...
.app-title{ color: #2d82b5;font-size:2.5rem;font-weight:750;margin-top:-62px;text-align:center;letter-spacing:0.5px;margin-bottom:1px; }
